 ...
 */
class SpotifySyncPlaylistsFragmentVM(fragment: SpotifySyncPlaylistsFragment, binding: SpotifySyncPlaylistsFragmentBinding)
    : DialogBottomSheetBaseVM<SpotifySyncPlaylistsFragment, SpotifySyncPlaylistsFragmentBinding>(fragment, binding) {
