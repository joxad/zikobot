 ...
 */
class PlaylistDetailActivityVM(activity: PlaylistDetailActivity, binding: PlaylistDetailActivityBinding, savedInstance: Bundle?)
    : ABasePlayerActivityVM<PlaylistDetailActivity, PlaylistDetailActivityBinding>(activity, binding, savedInstance) {
