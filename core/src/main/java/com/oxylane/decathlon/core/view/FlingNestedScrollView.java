...
/**
 * Nested scroll that fix the bug of fling
 * CHange the nestedscrollview by this one and add
 * NEED TO ADD :         rv.setNestedScrollingEnabled(false); in the activity/fragment
